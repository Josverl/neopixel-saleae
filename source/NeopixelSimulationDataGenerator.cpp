...
void NeopixelSimulationDataGenerator::Initialize( U32 simulation_sample_rate, NeopixelAnalyzerSettings* settings )
{
...
U32 NeopixelSimulationDataGenerator::GenerateSimulationData( U64 largest_sample_requested, U32 sample_rate, SimulationChannelDescriptor** simulation_channel )
{
...
void NeopixelSimulationDataGenerator::CreateSerialByte()
{
